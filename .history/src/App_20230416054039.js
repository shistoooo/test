...
function App() {
  ...
  // Dessine un quadrilatère avec une couleur spécifiée sur le canvas
  ...
  // Traitement de l'image et détection des quadrilatères
  useEffect(() => {
    if (imageSrc && canvasRef.current) {
      ...
      img.onload = async () => {
        ...
        // Ajoute un gestionnaire d'événement pour détecter les clics sur le canvas
        ...
        // Supprime le gestionnaire d'événement lors du nettoyage
        return () => {
